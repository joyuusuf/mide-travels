                ...
                <form method="post">
                    <div className="flex items-center gap-2 mt-5">
                        ...
                        <div className="relative w-full ">
                            ...
                            <input type="number" placeholder="5" className="border-2 border-gray-100 outline-0 rounded-md" required />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 mt-5">
                        ...
                        <div className="relative w-full ">
                            ...
                            <input type="number" placeholder="1" className="border-2 border-gray-100 outline-0 rounded-md" required />
                        </div>
                    </div>
                </form>
                <button type="button" className="btn text-white bg-[#193555] w-full font-bold py-4 rounded-md cursor-pointer transition-colors duration-300 mt-5"
